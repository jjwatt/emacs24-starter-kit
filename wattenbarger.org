...
#+BEGIN_SRC emacs-lisp
  ...
  (let ((default-directory "~/.emacs.d/subs/"))
...
(setq org-publish-project-alist
           '(("niweek-notes"
             ...
             ("project-support-notes"
              ...
              :publishing-directory "/google/data/rw/users/wa/wattenbarger/www/public_html"
              :html-head "<link rel=\"stylesheet\"
                         href=\"css/worg.css\"
                         type=\"text/css\"/>"
              :base-extension "org"
             ...
             ("project-support-static"
              ...
              :recursive t
              :publishing-function org-publish-attachment)
             ("project-support" :components ("project-support-notes" "project-support-static"))
             ))
#+END_SRC
...
* Google
If I'm loading my config at google, then I want to load the google
libs.

** TODO Make this conditional or fail silently
#+BEGIN_SRC emacs-lisp
